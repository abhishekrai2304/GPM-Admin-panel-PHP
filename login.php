...
if(isset($_POST["login"])) {
	$result = mysqli_query($conn,"SELECT * FROM admin WHERE email='" . $_POST["email"] . "' and password = '". $_POST["pass"]."'");
  ...
  <div class="login-box-body">
    ...
    <form action="" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" id="btn-submit" name="login" class="btn btn-primary btn-block btn-flat">Sign In</button>
        </div>
