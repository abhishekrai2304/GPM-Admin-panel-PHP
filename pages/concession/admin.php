    ...
    <div class="nav-tabs-custom">
      ...
      <div class="tab-content">
        ...
        <div class="box box-primary">
            ...
            <form method="POST" name="submitSear" id="submitSear" action="pdf_new.php" enctype="multipart/form-data" >
             <div class="box-body" >
             ...
             <div class="box-footer">
               <button type="submit" name="submitSear" id="submitSear" class="btn btn-primary">Submit</button>
             </div>
