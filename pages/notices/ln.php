...
if(isset($_POST['upload'])){
    $target = "./pdf/".basename($_FILES['filename']['name']);
    ...
    $sql = "INSERT INTO ln (name,link,filename,category) VALUES ('$name','$link','$filename','$category')";
    ...
    <div class="nav-tabs-custom">
      ...
      <div class="tab-content">
        ...
        <div class="box box-primary">
            ...
            <form method="POST" name="submitSear" id="submitSear" action="ln.php" enctype="multipart/form-data" >
            <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <option value="ln" >latest news</option>
                  <option value="sc" >student section</option>
